...
- To avoid processing all messages, you can manually create this file with a starting message number, e.g.: `3187`. It can also be helpful to reset this to 0 when troubleshooting the scripts.
